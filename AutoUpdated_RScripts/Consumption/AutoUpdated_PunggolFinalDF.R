...
#DB_Consumption_2017 <- DB_Consumption[date(date_consumption)>="2017-01-01" & date(date_consumption)<="2017-12-31"]
...
#write.fst(DB_Consumption_2017,"/srv/shiny-server/DataAnalyticsPortal/data/DB_Consumption_2017.fst", 100)
...
#DB_Consumption_2017_servicepoint <- inner_join(DB_Consumption_2017,servicepoint,by=c("id_service_point"="id"))

# Punggol_2017 <- DB_Consumption_2017_servicepoint %>%
#   dplyr::mutate(Date=date(adjusted_date),D=day(adjusted_date),M=month(adjusted_date)) %>%
...
Yuhua_thisyear$Consumption <- Yuhua_thisyear$interpolated_consumption

write.fst(Punggol_thisyear,"/srv/shiny-server/DataAnalyticsPortal/data/Punggol_thisyear.fst", 100) 
write.fst(Yuhua_thisyear,"/srv/shiny-server/DataAnalyticsPortal/data/Yuhua_thisyear.fst", 100) 
