...
consumption_last90days <- dbSendQuery(con1, paste("SELECT id_service_point,interpolated_consumption,adjusted_consumption,date_consumption
                                                 FROM consumption
                                                 WHERE date(date_consumption) >= '",last90days,"'",sep=""))
