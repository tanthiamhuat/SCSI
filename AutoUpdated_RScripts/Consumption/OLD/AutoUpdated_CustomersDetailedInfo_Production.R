...
pacman::p_load(RPostgreSQL,plyr,dplyr,lubridate,data.table,mailR)
...
ans <- paste("AutoUpdated_CustomerDetailedInfo_Production successfully completed in",round(time_taken[3],2),"seconds.")
print(ans)
