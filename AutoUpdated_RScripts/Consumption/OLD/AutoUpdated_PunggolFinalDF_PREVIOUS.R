...
#DB_Consumption_lastyear <- DB_Consumption[date(date_consumption)>=lastyear_start & date(date_consumption)<=lastyear_end]
...
#fstwrite(DB_Consumption_lastyear,"/srv/shiny-server/DataAnalyticsPortal/data/DB_Consumption_lastyear.fst", 100) 
...
DB_Index_last30days <- DB_Index[date(current_index_date)>=last30days]
DB_Index_last6months <- DB_Index[date(current_index_date)>=last6months]
#DB_Index_lastyear <- DB_Index[date(current_index_date)>=lastyear_start & date(current_index_date)<=lastyear_end]
...
#fstwrite(DB_Index_lastyear,"/srv/shiny-server/DataAnalyticsPortal/data/DB_Index_lastyear.fst", 100) 
...
save(Punggol_All,Week.date,Updated_DateTime_HourlyCons, 
     file="/srv/shiny-server/DataAnalyticsPortal/data/Punggol_Final_DF_V2.RData")
...
fstwrite(Punggol_All,"/srv/shiny-server/DataAnalyticsPortal/data/Punggol_Final_DF_V2.fst", 100) 
...
Punggol_last6months <- Punggol_All %>% dplyr::filter(Date>=last6months)
fstwrite(Punggol_last6months,"/srv/shiny-server/DataAnalyticsPortal/data/Punggol_last6months.fst", 100) 

Punggol_last30days <- Punggol_All %>% dplyr::filter(Date>=last30days)
