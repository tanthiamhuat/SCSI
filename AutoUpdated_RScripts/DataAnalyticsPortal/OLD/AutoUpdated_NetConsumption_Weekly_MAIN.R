...
colnames(WeeklyNetConsumptionCSV_New) <- c("Date","Block","IndirectMainMeters","IndirectSubMeters","IndirectNetConsumption","IndirectNetConsumptionRate",
...
ans <- paste("AutoUpdated_NetConsumption successfully completed in",round(time_taken[3],2),"seconds on",now())
print(ans)
