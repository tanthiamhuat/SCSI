...
## every Monday
#days <- seq(as.Date("2016-09-12"),as.Date("2017-07-10"),by=7)
#days <- seq(as.Date("2017-07-03"),as.Date("2017-07-10"),by=7)
days <- seq(as.Date("2016-09-12"),as.Date("2017-08-21"),by=7)
...
colnames(WeeklyNetConsumption) <- c("Date","Block","IndirectMainMeters","IndirectNetConsumption",
                                    "DirectMainMeters","DirectNetConsumption","TotalMainMeters","TotalNetConsumption",
                                    "TotalNetConsumptionRate")
colnames(WeeklyNetConsumptionCSV) <- c("Date","Block","IndirectMainMeters","IndirectSubMeters","IndirectNetConsumption",
