...
LPCD_PerMonth_lastrow[nrow(LPCD_PerMonth_lastrow),3] <- round(LPCD_PerMonth_lastrow[nrow(LPCD_PerMonth_lastrow),3]*LPCD_PerMonth_lastrow[nrow(LPCD_PerMonth_lastrow),4]/daysPast)
...
save(DailyLPCD,DailyLPCD_xts,DailyLPCD_Block,familymembers_Block,
